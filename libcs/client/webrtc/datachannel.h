...
void onDataChannelStateChange(int state, int id, void *DataChannel, void *userData);
void onDataChannelMessage(void *buf, int bufLen, void *DataChannel, void *userData);
