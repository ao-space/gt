export namespace zh {
  ...
  export const cusage = {
    // 通用设置
    Config: "要加载的配置文件路径",
    ID: "用于连接服务器的唯一标识。目前是域名的前缀。",
    Secret: "用于验证标识的密钥",
    ReconnectDelay: "重新连接之前的延迟。支持值如 '30s'、'5m'",
    Remote: "远程服务器的 URL。支持 tcp:// 和 tls://，默认为 tcp://",
    RemoteSTUN: "远程 STUN 服务器地址",
    RemoteAPI: "获取远程服务器 URL 的 API",
    RemoteCert: "远程证书的路径",
    RemoteCertInsecure: "接受远程自签名的 SSL 证书",
    ...
    RemoteTCPPort: "远程服务器将打开的 TCP 端口",
    RemoteTCPRandom: "远程服务器是否随机选择一个端口",
    Local: "本地服务的 URL",
    LocalURL: "本地服务的 URL",
    LocalTimeout: "本地连接的超时时间。支持值如 '30s'、'5m'",
    UseLocalAsHTTPHost: "使用本地主机作为主机",
  ...
  export const sconfig = {
    ...
    AddService: "添加服务",
    DetailSettings: "额外配置项",
    //server config form index
    AddTcpRanges: "请添加TCP端口范围和数量",
  ...
  export const cconfig = {
    ...
    RemoteTimeout: "远程超时",
    Remote: "远程",
    RemoteSTUN: "远程 STUN 地址",
    RemoteAPI: "远程 API",
    RemoteCert: "远程证书",
    RemoteCertInsecure: "远程不安全证书",
    RemoteConnections: "远程连接数",
    RemoteIdleConnections: "远程空闲连接数",
    LogFile: "日志文件",
    ...
    HostPrefix: "主机前缀",
    RemoteTCPPort: "远程 TCP 端口",
    RemoteTCPRandom: "远程 TCP 随机端口",
    LocalURL: "本地 URL",
    LocalTimeout: "本地超时",
    UseLocalAsHTTPHost: "使用本地主机作为主机",
